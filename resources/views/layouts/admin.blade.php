...
<script type="text/javascript">
  $(function() {
    ...
    @elseif(Session::has('delete_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('update_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('add_typeroom_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('add_typeroom_error_flash_message'))
    $('.swalDefaultError').ready(function() {
      Toast.fire({
        icon: 'error',
    ...
    @elseif(Session::has('update_typeroom_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('delete_typeroom_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('add_room_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('add_room_error_flash_message'))
    $('.swalDefaultError').ready(function() {
      Toast.fire({
        icon: 'error',
    ...
    @elseif(Session::has('update_room_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('delete_room_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',
    ...
    @elseif(Session::has('delete_user_success_flash_message'))
    $('.swalDefaultSuccess').ready(function() {
      Toast.fire({
        icon: 'success',

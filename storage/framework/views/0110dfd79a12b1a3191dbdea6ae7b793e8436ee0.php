				...
				<div class="card mb-4" id="sectionInforCus">
					...
					<div class="card-body">
							<div class="form-row mb-4">
								...
								<div class="col">
									...
									<select name="gender" class="form-control">
										<option value="Nam"
										<?php if(Auth::user()->gender == 'Nam'): ?>
											selected
										<?php endif; ?>
										>Nam</option>
										<option value="Nữ"
										<?php if(Auth::user()->gender == 'Nữ'): ?>
											selected
										<?php endif; ?>
										>Nữ</option>
									</select>					
							...
							<div class="form-row mb-4">
								...
								<div class="col">
									<span>CMND</span>
									<input type="text" class="form-control" name="identity_card_number" value="<?php echo e(Auth::user()->identity_card_number); ?>">
								</div>
							</div> 
							...
							<div class="form-row mb-4">							
								<div class="col">
									...
									<input type="date" class="form-control" name="date_move_in" required min="<?php echo e(date_format(now(),'Y-m-d')); ?>"
									max="<?php echo e(date_format(date_modify(date_create(date('Y-m-d')),'+3 days'),'Y-m-d')); ?>">						
								</div>							
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/xampp/htdocs/laravel_dormitory/resources/views/pages/checkout.blade.php ENDPATH**/ ?>
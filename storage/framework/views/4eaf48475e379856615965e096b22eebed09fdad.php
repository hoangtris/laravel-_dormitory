		  ...
		  <div class="row">
		    ...
		    <div class="col-lg-6">
		      ...
		      <div class="card card-success card-outline collapsed-card">
		        <div class="card-header">
		          <h5 class="card-title m-0">Thêm loại phòng</h5>
		          <div class="card-tools">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/xampp/htdocs/laravel_dormitory/resources/views/admin/typesroom/index.blade.php ENDPATH**/ ?>
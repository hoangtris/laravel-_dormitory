...
<?php $__env->startSection('content'); ?>
	<div id="demo" class="carousel slide" data-ride="carousel">
	    ...
	    <div class="carousel-inner">
	    	<div class="carousel-item active">
				<img src="<?php echo e(asset('image/02072020_8-8.jpg')); ?>" width="100%" height="400px" style="object-fit: cover;">
			...
			<div class="carousel-item">
				<img src="<?php echo e(asset('image/30062020_5-loai-chi-phi-khi-du-hoc-Singapore-du-hoc-sinh-phai-biet-2.jpg')); ?>" width="100%" height="400px" style="object-fit: cover;">
				<div class="carousel-caption">
			...
			<div class="carousel-item">
				<img src="<?php echo e(asset('image/02072020_kinh-nghiem-tim-phong-tro-gia-re-top-xx-website-t-4.jpg')); ?>" width="100%" height="400px" style="object-fit: cover;">
				<div class="carousel-caption">
					<h3>Phòng 4 người</h3>
	...
	<div class="mt-4 text-center">
		<div class="container">
			...
			<hr class="">
			<img src="<?php echo e(asset('image/logoKTX.jpg')); ?>" alt="" width="400px">
			...
			<section class="px-md-1 mx-md-1 light-grey-text text-center text-lg-left">
			  ...
			  <div class="row">
				...
				<div class="col-lg-6 mb-4 mb-lg-0 d-flex align-items-center justify-content-center">
				  <img src="<?php echo e(asset('image/01072020_display-pic.jpg')); ?>" width="400px" alt="mota">
				</div>
				<!--Grid column-->
				...
				<div class="col-lg-6 mb-4 mb-lg-0">
				  ...
				  <a class="btn btn-primary" href="<?php echo e(route('rooms.all')); ?>" >Xem phòng<i class="fa fa-angle-right ml-2"></i></a>
				</div>
				<!--Grid column-->
			  </div>
			  <!--Grid row-->
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/xampp/htdocs/laravel_dormitory/resources/views/pages/index.blade.php ENDPATH**/ ?>
	...
	<section class="dark-grey-text mb-5">
		...
		<div class="row">
			...
			<div class="col-lg-5 mb-lg-0 pb-lg-3 mb-4">
				...
				<div class="card">
					<div class="card-body">
						<form action="<?php echo e(route('contact.store')); ?>" method="post" accept-charset="utf-8">
							<?php echo csrf_field(); ?>
							<!-- Header -->
...
<?php echo $__env->make('master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/c/xampp/htdocs/laravel_dormitory/resources/views/pages/contact.blade.php ENDPATH**/ ?>
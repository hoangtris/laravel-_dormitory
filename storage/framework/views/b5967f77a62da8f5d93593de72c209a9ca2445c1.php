...
<div class="container-fluid px-5 pt-5">
	...
	<div class="row">
		...
		<div class="col-3 mb-3">
			...
			<form class="example" action="<?php echo e(route('rooms.search')); ?>" method="get" class="form-inline">
				<div class="input-group mb-3">
					<input type="text" class="form-control" placeholder="Nhập giá trị..." name="key">
			...
			<div class="list-group">
				<?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
						...
						<a href="<?php echo e(route('rooms.detail', $p->id)); ?>"><img class="card-img-top"
							...
							<div class="card-body">
								...
								<div class="card-text">Loại phòng: 
									<?php $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

			...
			<aside class="main-sidebar sidebar-dark-primary elevation-4">
				...
				<div class="sidebar">
					...
					<div class="user-panel mt-3 pb-3 d-flex">
						<div class="image">
							<?php if($user->gender == 'Nam'): ?>
								<img src="<?php echo e(asset('adminlte/dist/img/avatar5.png')); ?>" class="img-circle elevation-2" alt="User Image">
							<?php else: ?>
								<img src="<?php echo e(asset('adminlte/dist/img/avatar2.png')); ?>" class="img-circle elevation-2" alt="User Image">
							<?php endif; ?>
			 	...
			 	<!-- Add icons to the links using the .nav-icon class
			 		...
			 		<li class="nav-item user-panel mb-2">
			 			<a href="<?php echo e(route('rooms.all')); ?>" class="nav-link">
			 		...
			 		<li class="nav-item">
			 			<a href="<?php echo e(route('client.dashboard')); ?>" class="nav-link active">
			 		...
			 		<li class="nav-item">
			 			<a href="<?php echo e(route('client.information')); ?>" class="nav-link">
			 		...
			 		<li class="nav-item">
			 			<a href="<?php echo e(route('client.password.edit')); ?>" class="nav-link">
			 		...
			 		<li class="nav-item">
			 			<a href="<?php echo e(route('client.room')); ?>" class="nav-link">
			 		...
			 		<li class="nav-item">
			 			<a href="<?php echo e(route('client.notification.index')); ?>" class="nav-link">
...
<?php /**PATH /mnt/c/xampp/htdocs/laravel_dormitory/resources/views/layouts/client.blade.php ENDPATH**/ ?>